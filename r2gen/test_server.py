...
def main():
    dir_path = "/root/lihao/r2gen"
    tester = MyModel(dir_path)

    args = parse_agrs()
    test_dataloader = mydataloader(dir_path+'/test.jpg', args)
    result = tester.test(test_dataloader, '/root/lihao/r2gen/results/mimic_cxr/model_mimic_cxr.pth')
    print(result)
